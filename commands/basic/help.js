...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.isCommand && interaction.isCommand()) {
            ...
            const BOT_ICON = "https://cdn.discordapp.com/attachments/1334781602387070976/1371364421376413767/developer_bot.gif?ex=6822de24&is=68218ca4&hm=6302817b8635c3c995f1605900f4d10b57d40de4f126edf39b4d06c6cd9a85c2&";
            const EMBED_COLOR = "#5865F2"; 
            const FOOTER_TEXT = "ARNAB ULTIMATE | Created by ARNAB";
            ...
            const createPages = (commandSet, type) => {
                ...
                pages.push({
                    title: '✨ ARNAB ULTIMATE BOT',
                    description: [
                        '### Bot Information',
                        '',
                        '> Welcome to the help command! This bot provides a variety of commands to enhance your server experience. Below are the categories and the number of commands available in each.',
                        '',
                        '**BOT STATISTICS**',
                        `\`🧠\` **Version:** 1.2.2`,
                    ...
                    author: { name: 'ARNAB ULTIMATE BOT V 2.0 • COMMAND CENTER' },
                    icon: '📚'
                });
            ...
            const embed = new EmbedBuilder()
                ...
                .setFooter({ text: 'ARNAB ULTIMATE V 2.0 Bot • Error' })
                .setTimestamp();
